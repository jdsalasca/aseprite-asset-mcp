...
async function main(): Promise<void> {
  ...
  const presets = [
    { id: "living-forest", title: "Living forest", description: "Trees, wildlife, rain and fire-ready effects for a layered forest scene.", category: "flora", itemIds: ["oak", "pine", "wolf", "owl", "rain", "fire"], recommendedTools: ["generate_world_map", "generate_environment_pack", "generate_day_night_cycle"], deterministic: true as const },
    { id: "coastal-sunset", title: "Coastal sunset", description: "Beach, ocean, reflections, birds and a time-of-day transition.", category: "biomes-and-maps", itemIds: ["beach", "ocean", "coral-reef", "seagull", "wave-reflection", "coast"], recommendedTools: ["generate_beach_scene", "generate_day_night_cycle", "apply_depth_lighting"], deterministic: true as const },
    ...
    { id: "rainy-village", title: "Rainy village", description: "Village interiors, church bell, rain and inhabitants.", category: "interiors", itemIds: ["village", "church", "church-bell", "rain", "veteran-merchant", "apprentice-farmer"], recommendedTools: ["generate_environment_pack", "generate_day_night_cycle", "generate_particle_burst"], deterministic: true as const },
  ];
