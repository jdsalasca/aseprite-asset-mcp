...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 26 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  goal: "complete-typescript-migration",
  continue: true,
  currentPhase: "native-fx",
  currentSlice: "native-color-effects",
  lastCompletedSlice: "opacity-and-palette-analysis",
  nextSlice: "convolution-and-dither-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
