...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 35 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  currentSlice: "transform-tools",
  lastCompletedSlice: "selection-tools",
  nextSlice: "text-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
