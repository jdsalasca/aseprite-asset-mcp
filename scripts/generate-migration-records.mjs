...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 43 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  currentSlice: "quality-tools",
  lastCompletedSlice: "slice-tools",
  nextSlice: "preview-scene-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
