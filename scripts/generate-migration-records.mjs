...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 48 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  currentSlice: "animation-controls",
  lastCompletedSlice: "preview-scene-tools",
  nextSlice: "final-audit",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
