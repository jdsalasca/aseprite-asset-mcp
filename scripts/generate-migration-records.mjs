...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 21 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  goal: "complete-typescript-migration",
  continue: true,
  currentPhase: "cel-tools",
  currentSlice: "import-and-cel-copy",
  lastCompletedSlice: "layer-and-tag-export",
  nextSlice: "frame-propagation-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
