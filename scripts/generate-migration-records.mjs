...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 22 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  goal: "complete-typescript-migration",
  continue: true,
  currentPhase: "frame-motion",
  currentSlice: "position-and-propagation",
  lastCompletedSlice: "import-and-cel-copy",
  nextSlice: "animation-copy-and-delete-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
