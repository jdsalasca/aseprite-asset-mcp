...
writeFileSync(join(recordsDir, "migration.graph.json"), JSON.stringify({
  ...
  local: { branch, worktree, baseCommit: localCommit, typescriptToolCount: typescriptTools.length, testCount: 33 },
  tools,
  nodes: [
...
writeFileSync(join(root, ".harness-moon", "continuation-state.json"), JSON.stringify({
  ...
  currentSlice: "selection-tools",
  lastCompletedSlice: "pixel-read-tools",
  nextSlice: "transform-tools",
  blocked: false,
  retryCount: 0,
  lastEvidence: [
