...
export type SceneEffectKind = "rain" | "fog" | "snow" | "smoke" | "fire" | "lightning" | "waves" | "water_spray" | "dust" | "water_reflection" | "water_caustics" | "wind_sway" | "sprite_shadow" | "sprite_glow" | "day_night" | "material_texture" | "depth_lighting" | "particles";
