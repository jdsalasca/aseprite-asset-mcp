...
const DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  apply_sprite_specular_highlight: "Apply deterministic inward specular highlights to sprites.",
  apply_sprite_color_ramp: "Map sprite luminance into deterministic shadow, midtone, and highlight palette bands.",
  apply_sprite_grain: "Apply deterministic seeded grain to opaque sprites for material and weathered-surface detail.",
  apply_sprite_dither: "Apply deterministic Bayer dithering between two palette colors while preserving alpha.",
  apply_sprite_color_temperature: "Apply deterministic warm or cool temperature for day, night, sunset, and firelight.",
  generate_sprite_silhouette: "Generate a deterministic monochrome silhouette for masks, shadows, previews, and collision workflows.",
  generate_wind_sway: "Generate a deterministic looping wind sway for trees, foliage, flags, grass, and hanging props.",
  ...
  generate_fire_overlay: "Generate deterministic animated firelight and ember flicker with bounded intensity while preserving source alpha and timing.",
  generate_lightning_overlay: "Generate deterministic animated lightning flashes with a bounded bolt path while preserving source alpha and timing.",
  generate_wave_overlay: "Generate deterministic animated shoreline waves and foam while preserving source alpha, dimensions, and timing.",
  generate_water_spray: "Generate deterministic animated sea spray droplets for waves, waterfalls, and shoreline impacts while preserving source alpha and timing.",
  generate_dust_overlay: "Generate deterministic animated dust grains for walking, impacts, deserts, and dusty interiors while preserving source alpha and timing.",
  generate_leaf_fall_overlay: "Generate deterministic animated falling leaves for forests and autumn scenes while preserving source alpha and timing.",
  generate_water_ripple_overlay: "Generate deterministic animated ripple rings for puddles and shallow water while preserving source alpha and timing.",
  ...
  generate_scene_effect_stack: "Generate selected scene effects in one deterministic response, including wind sway, shadow, and glow, while preserving the source.",
