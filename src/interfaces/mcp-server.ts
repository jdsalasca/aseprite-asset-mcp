...
export class AsepriteMcpServerAdapter {
  ...
  private registerTools(): void {
    ...
    new AssetLibraryToolController(this.assetLibrary, this.assetLibraryAudit, this.assetLibrarySummary).register(this.server);
