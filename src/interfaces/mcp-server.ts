...
import { EnhancementBatchService } from "../application/services/EnhancementBatchService.js";
import { EnhancementBatchToolController } from "./controllers/EnhancementBatchToolController.js";
...
import { AssetLibrarySummaryService } from "../application/services/AssetLibrarySummaryService.js";
import { AssetScenePlannerService } from "../application/services/AssetScenePlannerService.js";
import { AssetSceneComposerService } from "../application/services/AssetSceneComposerService.js";
import { AssetSceneAnimationComposerService } from "../application/services/AssetSceneAnimationComposerService.js";
...
import { AssetSceneRecommendationService } from "../application/services/AssetSceneRecommendationService.js";
...
const TOOL_NAMES = [
  ...
  "generate_leaf_fall_overlay",
  "generate_water_ripple_overlay",
...
export class AsepriteMcpServerAdapter {
  ...
  private readonly enhancementBatch: EnhancementBatchService;
  ...
  private readonly assetLibrarySummary: AssetLibrarySummaryService;
  private readonly assetScenePlanner: AssetScenePlannerService;
  ...
  private readonly assetSceneRecommendation: AssetSceneRecommendationService;
  private readonly assetSceneBundle: AssetSceneBundleService;
  ...
  public constructor(private readonly assets: AssetGatewayPort, imageAssets?: PixelArtAssetService, jobStore?: AssetJobStorePort) {
    ...
    this.assetLibrarySummary = new AssetLibrarySummaryService(new FileAssetLibraryAdapter());
    this.assetScenePlanner = new AssetScenePlannerService(new FileAssetLibraryAdapter());
    this.assetSceneComposer = new AssetSceneComposerService(new FileAssetLibraryAdapter(), rasterCodec, rasterCodec, manifestWriter);
    ...
    this.assetSceneRecommendation = new AssetSceneRecommendationService(new FileAssetLibraryAdapter());
    this.assetSceneBundle = new AssetSceneBundleService(this.assetSceneComposer, this.assetSceneAnimationComposer);
