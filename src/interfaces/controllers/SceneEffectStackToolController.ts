...
const effects = ["rain", "fog", "snow", "smoke", "fire", "water_reflection", "water_caustics", "wind_sway", "sprite_shadow", "sprite_glow", "day_night", "material_texture", "depth_lighting", "particles"] as const;
