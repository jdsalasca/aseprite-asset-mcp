...
const effects = ["rain", "water_reflection", "water_caustics", "wind_sway", "day_night", "material_texture", "depth_lighting", "particles"] as const;
