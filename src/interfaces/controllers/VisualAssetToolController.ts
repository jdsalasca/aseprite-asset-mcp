...
export class VisualAssetToolController {
  ...
  public register(server: McpServer): void {
    ...
    server.registerTool("extend_scene", {
      description: "Extend an existing deterministic scene around its borders while preserving the original layers and landmarks.",
